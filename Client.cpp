...
int main(int argc, char *argv[])
{
    ...
    int respStringLen;
    WSADATA wsaData;
    servIP = "192.168.1.8"; //Change this to your local IP address or the IP address of the server
    echoString = "hello";
    ...
    if ((respStringLen = recvfrom(sock, echoBuffer, ECHOMAX, 0, (struct sockaddr *) (int*)&fromAddr, (int*)&fromSize)) != echoStringLen)
    {
    ...
    if (echoBuffer[respStringLen-1])
        cout << "Received an unterminated string, not printing\n";
    else
